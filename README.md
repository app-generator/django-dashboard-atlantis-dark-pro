...
- UI Kit: **Atlantis Dark** (PRO Version) provided by **ThemeKita**
...
- [Django Atlantis Dark PRO](https://django-dashboard-atlantis-dark-pro.appseed.us/) - LIVE Demo
- [Django Atlantis Dark PRO](https://appseed.us/admin-dashboards/django-dashboard-atlantis-dark-pro) - Official product page
...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-django-dashboard-atlantis-dark-pro.git
$ cd priv-django-dashboard-atlantis-dark-pro
$
...
---
[Django Atlantis Dark PRO](https://appseed.us/admin-dashboards/django-dashboard-atlantis-dark-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
